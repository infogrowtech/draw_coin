...
{
    const char* pszTimestamp = "Make Dash great again Sep 17/2024";
    const CScript genesisOutputScript = CScript() << ParseHex("04a47056ab52e813555695bb324bcc6150bc9a7efefa87cd4bd8eefc616a6c8e7b2fcfa96cd89d4fa376f20ef2c416f759699f3086013e1f21ee6a251683a54849") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1726566782, 773728, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000057a1347cb6b7ac1880a25d4795f0c2bdc1e7fd65f0225ada36b4f56a745"));
        assert(genesis.hashMerkleRoot == uint256S("0x8a760b853a887d3f82a5cd2384db061e9fcf689d90487e51466f54b3ece3aaab"));
        ...
        vSeeds.emplace_back("104.251.216.151");
        vSeeds.emplace_back("63.142.251.59");

        // Dash addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,32); // new coin start with D
        ...
        checkpointData = {
            {
                {0, uint256S("0x0000057a1347cb6b7ac1880a25d4795f0c2bdc1e7fd65f0225ada36b4f56a745")},
        ...
        chainTxData = ChainTxData{
            1726566782, // * UNIX timestamp of last known number of transactions (Block 1450962)
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1726566782UL, 773728UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000057a1347cb6b7ac1880a25d4795f0c2bdc1e7fd65f0225ada36b4f56a745"));
        assert(genesis.hashMerkleRoot == uint256S("0x8a760b853a887d3f82a5cd2384db061e9fcf689d90487e51466f54b3ece3aaab"));
        ...
        vSeeds.emplace_back("testnet-seed.draw.io"); // Just a static list of stable node(s), only supports x9

        // Testnet Dash addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,90); // new coin address start with d
        ...
        chainTxData = ChainTxData{
            1726566782, // * UNIX timestamp of last known number of transactions (Block 477483)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        genesis = CreateGenesisBlock(1726566782, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6bd6d3b72f6eb5dde42395c2ecbb209ca249ffa9efba719d502957f19d6fb7af"));
        assert(genesis.hashMerkleRoot == uint256S("0x8a760b853a887d3f82a5cd2384db061e9fcf689d90487e51466f54b3ece3aaab"));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x6bd6d3b72f6eb5dde42395c2ecbb209ca249ffa9efba719d502957f19d6fb7af")},
